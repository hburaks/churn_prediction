...
print("--- Optimize Edilmiş XGBoost Modeli İçin Eşik Ayarlaması ---")
...
try:
    ...
    # RandomizedSearchCV tarafından bulunan en iyi parametreler
    best_params = {
        'alpha': 0.1098453329412241,
        'colsample_bytree': 0.8858383690800249,
        'gamma': 0.13203947534354626,
        'lambda': 1.5598677938918857,
        'learning_rate': 0.20097305613263883,
        'max_depth': 9,
        'n_estimators': 291,
        'subsample': 0.8217416210045603
    }

    # Optimize edilmiş XGBoost Modelini Tanımla ve Eğit
    model = xgb.XGBClassifier(
        ...
        random_state=42,
        **best_params # En iyi parametreleri buraya aktarıyoruz
    )
    ...
    print("\n--- Farklı Karar Eşikleri ile Optimize Edilmiş Model Değerlendirme ---")
